...
/**
 * Created by CBrown on 2/8/2016.
 */
public class Red_Delay_Autonomous extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException
    {
        ...
        for (int i = 0; i <1; i++)
        {
            ...
            hammer.setPosition(0);
            resetDriveMotorEncoders(mleft1, mright1);
            sleep(500);

            driveBackwardstoEncoderCount(2400);
            resetDriveMotorEncoders(mleft1, mright1);
            sleep(500);
            ...
            driveForwardtoEncoderCount(2400);
            resetDriveMotorEncoders(mleft1, mright1);
            sleep(500);
            ...
            while(mleft1.getCurrentPosition() < 3600 && mright1.getCurrentPosition() < 3600
                    && this.opModeIsActive())
            {
                mleft1.setPower(1);
                mleft2.setPower(1);
